...
import com.nishidhpatel.mvvm.Repository.*
import com.nishidhpatel.mvvm.Utils.CAT_API_BASE_URL
...
val appmodules = module {
    ...
    factory<MuseumsListRepository> { MuseumsListRepositoryImpl(get()) }
    viewModel { MuseumListViewModel(get()) }
